...
const QAPage = () => {
  ...
  const question = questions?.[questionIndex? questionIndex : 0];
      ...
      <div className='flex items-center gap-4 bg-white rounded-lg p-4 shadow border'>
        ...
        <div className='text-left flex flex-col'>
          <div className="felx items-center gap-2">
            ...
            <span className='text-sx text-gray-400 whitespace-nowrap'>{question?.createdAt.toLocaleDateString()}</span>
          </div>
